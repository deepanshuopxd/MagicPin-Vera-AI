...
BOT_URL = "https://magicpin-vera-ai-wh3h.onrender.com"

# Choose your LLM provider: "openai", "anthropic", "gemini", "deepseek", "groq", "ollama", "openrouter"
LLM_PROVIDER = "groq"

# Your API key (loaded from bot/.env automatically — do NOT hardcode here)
LLM_API_KEY = ""  # Set after imports below
...
# Load API key from bot/.env (keeps secrets out of source code)
from dotenv import load_dotenv as _load_dotenv
_load_dotenv(Path(__file__).parent / "bot" / ".env")
LLM_API_KEY = os.environ.get("GROQ_API_KEY", LLM_API_KEY)
